...
- 도서 추천은 횟수와 권수 제한 없이 이용할 수 있습니다. 로그인 사용자는 한국 시간 기준 하루 최대 30권을 나의 서재에 추가할 수 있고, 그중 처음 5권에 권당 1 EXP를 적립합니다. 같은 책을 삭제 후 다시 추가해도 당일 카운트와 EXP는 중복되지 않습니다.
- 챌린지는 서버에 저장된 `challenge_posts.achievement × 3`을 적립합니다. 달성량 수정·게시글 삭제에 따라 EXP와 해금 상태를 다시 계산합니다.
